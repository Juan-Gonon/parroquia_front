...
import { ModalAsignEvent } from '../../features/groupDetails/ModalAsigEvent'

export const GroupAsigEventPage = () => {
  const { id } = useParams()
  ...
  return (
    <Container>
      ...
      <Header>
        ...
        <AddButtonC textBtn='Añadir a evento' handleClick={handleOpenModal} />
        <ModalAsignEvent grupo={grupos} onCreated={refreshMembers} />
      </Header>
